...
(function (GK) {
  ...
  var WB = {
    ...
    'Tiefsee-Schatz': 'Deep Sea Treasure',
    /* Kristall-Kaskade */
    'Kristall-Kaskade': 'Crystal Cascade',
    'Keine Linien — acht gleiche Steine irgendwo zahlen. Was zahlt, zerspringt, der Rest fällt nach.':
      'No paylines — eight matching stones anywhere pay. Whatever pays shatters, the rest tumbles down.',
    'KETTEN ×8': 'CHAINS ×8',
    '💎 DREHEN': '💎 SPIN',
    'AB 8 GLEICHEN — HÖCHSTE STUFE (12+)': 'FROM 8 MATCHING — TOP TIER (12+)',
    'Die Steine fallen…': 'The stones are falling…',
    'Freispiel — die Glut bleibt liegen…': 'Free spin — the embers stay put…',
    'Nichts zersprungen. Nächster Dreh.': 'Nothing shattered. Next spin.',
    'Glutkern': 'Ember', 'Freilos': 'Free ticket',
    'Kirsche': 'Cherry', 'Pflaume': 'Plum', 'Melone': 'Melon',
    'Glocke': 'Bell', 'Stern': 'Star', 'Juwel': 'Gem', 'Krone': 'Crown',
    '🎟 FREISPIELE': '🎟 FREE SPINS', '· Glut bleibt liegen': '· embers stay put',
    'KETTE': 'CHAIN', '🔥 GLUT': '🔥 EMBERS', 'Königs-Poker': "King's Poker",
    ...
    'ADRESSE DES STROMS': 'STREAM ADDRESS', 'UNTERZEILE': 'SUBTITLE',
    'IN WELCHEN ANSTRICHEN?': 'IN WHICH SKINS?',
    '＋ ANLEGEN': '＋ ADD', '✓ ÄNDERN': '✓ SAVE', '✕ FORMULAR LEEREN': '✕ CLEAR FORM',
